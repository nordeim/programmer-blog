...
- [`REMEDIATION_PLAN.md`](./REMEDIATION_PLAN.md) — **Remediation plan**. ~97 TDD-sequenced tasks (R-1..R-97) across 14 sections (Phase 9 + 9.5 + Passes 3–8). Each task has RED test, GREEN implementation, REFACTOR step, and acceptance gate.
...
├── Master_Execution_Plan.md          # MEP — 9 phases + Phase 9/9.5 remediation (see `Project_Architecture_Document.md` §1.3 ADR-004 amendment)
...
| 2. Database + types + auth packages | ✅ Complete | Drizzle schema, edge-safe tokens, homegrown HMAC auth (@devlog/auth, ADR-004 amendment), shared Zod types |
